 ...
 */
public class ja_bufferedimage_putpixel_rgba extends CustomJavaAction<java.lang.Boolean>
{
	...
	public ja_bufferedimage_putpixel_rgba(IContext context, IMendixObject obj_bufferedimage, java.lang.Long x, java.lang.Long y, java.lang.Long r, java.lang.Long g, java.lang.Long b, java.lang.Long a)
	{
		super(context);
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		try{
			java.awt.image.BufferedImage bi=
				...
				;
				//int colold=bi.getRGB(x.intValue(),y.intValue());
				//int colnew=(a.intValue()<<24)|(r.intValue()<<16)|(g.intValue()<<8)|b.intValue();
				//int colcom=(a.intValue()<<24)|(r.intValue()<<16)|(g.intValue()<<8)|b.intValue();
				//comp e.g. outputRed = (foregroundRed * foregroundAlpha) + (backgroundRed * (1.0 - foregroundAlpha));
				int col=blendPixelsrgb(r.intValue(),g.intValue(),b.intValue(),a.intValue()/255.0,bi.getRGB(x.intValue(),y.intValue()));
				bi.setRGB(
					x.intValue(),
					y.intValue(),
					col
	...
	{
		return "ja_bufferedimage_putpixel_rgba";
	}
