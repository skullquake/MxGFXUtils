...
public class ja_bufferedimage_putpixel_rgb extends CustomJavaAction<java.lang.Boolean>
{
	...
	public ja_bufferedimage_putpixel_rgb(IContext context, IMendixObject obj_bufferedimage, java.lang.Long x, java.lang.Long y, java.lang.Long r, java.lang.Long g, java.lang.Long b)
	{
		super(context);
	...
	public java.lang.Boolean executeAction() throws Exception
	{
		...
		try{
			java.awt.image.BufferedImage bi=
				...
				;
				//int col=(255<<24)|(r.intValue()<<16)|(g.intValue()<<8)|b.intValue();
	...
	{
		return "ja_bufferedimage_putpixel_rgb";
	}
